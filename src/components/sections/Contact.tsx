...
icon: Mail,
label: "Email",
value: "[sonalsrao26@gmail.com](mailto:sonalsrao26@gmail.com)",
...
return ( <section id="contact" className="py-24 px-6 bg-[var(--bg-subtle)]"> <div className="max-w-6xl mx-auto">
<motion.div
...
```
      ...
      <p className="text-[var(--text-secondary)] leading-relaxed">
        I&apos;m actively seeking Data Analyst, Business Intelligence Analyst,
        Data Engineer, and Data Scientist opportunities in Sydney or remote
        across Australia. If you&apos;re hiring or would like to discuss
        data-driven solutions, I&apos;d love to connect.
      </p>
